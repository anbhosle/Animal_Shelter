...
const petList = [
  {
    "name": "Floora",
    "img": "../../assets/images/floora.png",
    "type": "Dog",
    "breed": "Labrador",
    "description": "Floora is a sweet 2 months old Labrador that is patiently waiting to find a new forever home. This girl really enjoys being able to go outside to run and play, but won't hesitate to play up a storm in the house if she has all of her favorite toys.",
    "age": "2 months",
    "inoculations": ["none"],
    "diseases": ["none"],
    "parasites": ["none"]
  ...
  {
    "name": "Juli",
    "img": "../../assets/images/juli.png",
    "type": "Dog",
    "breed": "Shih tzu",
    "description": "Juli here and I'm looking for my forever home to live out the best years of my life. I am full of energy. Everyday I'm learning new things, like how to walk on a leash, go potty outside, bark and play with toys and I still need some practice.",
    "age": "1 month",
  ...
  {
    "name": "Sherni",
    "img": "../../assets/images/sherni.png",
    "type": "Dog",
    "breed": "Jack Russell Terrier",
    "description": "Sherni is a happy, playful girl who will make you laugh and smile. She forms a bond quickly and will make a loyal companion and a wonderful family dog or a good companion for a single individual too since she likes to hang out and be with her human.",
    "age": "3 months",
  ...
  {
    "name": "Rosi",
    "img": "../../assets/images/rosi.png",
    "type": "Cat",
    "breed": "British Shorthair",
    "description": "Rosi is a beautiful girl. She is as soft as the finest velvet with a thick lush fur. Will love you until the last breath she takes as long as you are the one. She is picky about her affection. She loves cuddles and to stretch into your hands for a deeper relaxations.",
    "age": "6 months",
  ...
  {
    "name": "Jonny",
    "img": "../../assets/images/jonny.png",
    "type": "Cat",
    "breed": "British Shorthair",
    "description": "jonny is an adorable grey british shorthair male. He loves to play and snuggle. He is neutered and up to date on age appropriate vaccinations. He can be chatty and enjoys being held. Timmy has a lot to say and wants a person to share his thoughts with.",
